...
class List extends Component{
    ...
    Add = () => {
        //mengosongkan nilai nis, nama, dan alamat pada saat tombol add ditekan
        this.setState({
            nis: "",
            nama: "",
            alamat: "",
    ...
    render(){
        return(
            <div className="container">
                        ...
                        return(
                            <li className="list-group-item" key={index}>
                                ...
                                <button className="btn btn-sm btn-primary m-1" 
                                        onClick={() => this.Edit(item)} data-tonggle="modal" data-target="#modal">Edit</button>
                ...
                <button className="btn btn-sm btn-success m-3" onClick={this.Add} data-toggle="modal"
